...
import feature from '../assests/images/feature.jpg';
import team1 from '../assests/images/feature.jpg';
import team2 from '../assests/images/header-page.jpg';
import team3 from '../assests/images/about-2.jpg';
import team4 from '../assests/images/feature.jpg'
import { 
  Check, 
  Database, 
  Link, 
    ...
    <div className="overflow-hidden">
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              ...
              <p className="mb-4" style={{ color: 'black', lineHeight: '1.8' }}>
                Statify Solutions Limited is a leading provider of enterprise-grade ERP solutions 
                that transform business operations through digital innovation and strategic 
                process optimization.
              </p>
        ...
        <div className="container">
          <div className="row g-5">
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              ...
              <div className="row g-3">
                {[
                  { icon: Database, title: 'Centralized Data Processing', text: 'Unified data management across all departments' },
                  { icon: Link, title: 'Enterprise Integration', text: 'Seamless system integration ecosystem' },
                  { icon: LineChart, title: 'Real-time Analytics', text: 'AI-powered business intelligence dashboards' },
                  { icon: Shield, title: 'Security First', text: 'Enterprise-grade security protocols and Storage as well' }
                ].map((feature, index) => (
                  <div className="col-md-6 wow fadeIn" data-wow-delay={`0.${index + 1}s`} key={index}>
                    <div 
                      className="feature-item p-4 rounded"
                    ...
                    >
                      ...
                      >
                        <feature.icon size={40} color="#024A59" />
                      </div>
                      <h5 style={{ color: '#024A59' }}>{feature.title}</h5>
      ...
      <div className="container-xxl py-5">
        <div className="container">
          ...
          <div className="row g-4">
            {[
              { img: team1, name: 'Shadrack Kipkoech', role: 'CEO & CO-FOUNDER' },
              { img: team2, name: 'Philemon Limo', role: 'CEO & CO-FOUNDER' },
              { img: team3, name: 'Enock Cheruiyot', role: 'SOFTWARE ENGINEER' },
              { img: team4, name: 'Obadia Maasai', role: 'SOFTWARE ENGINEER' }
            ].map((member, index) => (
                ...
                <div className="team-item">
                  <div className="position-relative overflow-hidden">
                    ...
                    <div className="team-overlay">
                      <div className="d-flex align-items-center justify-content-center h-100">
                        <a className="btn btn-square mx-1" href="/">
                          <Linkedin size={20} color="#024A59" />
                        </a>
                        <a className="btn btn-square mx-1" href="/">
                          <Twitter size={20} color="#024A59" />
                        </a>
                        <a className="btn btn-square mx-1" href="/">
                          <Facebook size={20} color="#024A59" />
                        </a>
                      </div>
                    </div>
                  </div>
      ...
      <div className="container-fluid py-5 bg-light">
        <div className="container text-center wow fadeInUp" data-wow-delay="0.1s">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <h1 className="display-6 mb-4" style={{ color: 'black',fontFamily:'serif',fontStyle:'italic' }}>
                Ready to Transform Your Business?
              </h1>
              <p className="mb-4 lead" style={{ color: 'black',fontStyle:'oblique'}}>
                Let's discuss how we can help you achieve operational excellence through 
                intelligent enterprise solutions.
              </p>
              <a 
